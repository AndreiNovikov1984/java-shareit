...
public class ItemRequestController {
    ...
    public ResponseEntity<ItemRequestAnswerDto> getRequest(@RequestHeader("X-Sharer-User-Id") long userId, @PathVariable long requestId) {
    ...
    public ResponseEntity<ItemRequestDto> postRequest(@RequestHeader("X-Sharer-User-Id") long userID, @RequestBody ItemRequestDto itemRequestDto) {
